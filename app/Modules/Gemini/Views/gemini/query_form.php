...
<script>
    ...
    class UIManager {
        ...
        <div class="card blueprint-card shadow-sm border-primary" id="results-card">
            ...
            <div class="card-footer bg-transparent border-0 text-center"><small class="text-muted fst-italic">AI can make mistakes.</small></div>
        </div>`;
        ...
        <div class="card blueprint-card mt-4 shadow-sm border-primary ${processingClass}" id="results-card">
            ...
            ${!isProcessing ? '<div class="card-footer bg-body border-top text-center py-2"><small class="text-muted">Generated by Google Gemini / Imagen / Veo</small></div>' : ''}
        </div>`;
