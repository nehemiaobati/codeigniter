...
<script>
    ...
    class ViewRenderer {
        ...
        static renderResultCard() {
            return ViewTemplates.resultCard('Studio Output', ViewTemplates.resultToolbar(), ViewTemplates.resultBody(''));
        }

        static renderFileChip(id, name) {
            return ViewTemplates.fileChip(id, name);
        }

        static renderHistoryHeader(date) {
            const div = document.createElement('div');
            div.innerHTML = ViewTemplates.historyHeader(date);
        ...
        static renderHistoryItem(item) {
            ...
            const div = document.createElement('div');
            div.innerHTML = ViewTemplates.historyItem(
                item.unique_id,
        ...
        static renderLoadMoreButton() {
            const div = document.createElement('div');
            div.innerHTML = ViewTemplates.loadMoreBtn();
            return div.firstElementChild;
        }
    ...
    class MediaUploader {
        ...
        renderFileChip(id, name) {
            // Use ViewRenderer and safe DOM insertion
            const el = document.createElement('div');
            el.innerHTML = ViewRenderer.renderFileChip(id, name);
            const chip = el.firstElementChild; // Safe traversal
