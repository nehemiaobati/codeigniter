            ...
            <div class="row align-items-center gy-5">
                <div class="col-lg-7 order-2 order-lg-1 text-center text-lg-start">
                    ...
                    <div class="d-flex gap-2 justify-content-center justify-content-lg-start">
                        ...
                        <a href="<?= base_url('assets/Nehemia Obati Resume.pdf') ?>" class="btn btn-outline-primary btn-lg rounded-pill px-4" target="_blank">Download Resume</a>
                    </div>
                </div>
                <div class="col-lg-5 order-1 order-lg-2 text-center">
                    <div class="position-relative d-inline-block">
                        <div class="hero-bg-blur"></div>
                        <img src="<?= base_url('assets/images/potraitwebp.webp') ?>" alt="Nehemia Obati" class="hero-img rounded-circle shadow-lg">
                    </div>
                </div>
            </div>
        </section>
